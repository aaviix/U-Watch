...
// MARK: - Reusable Card View for Displaying Metrics
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    HealthDataCardView(
                        ...
                        value: String(format: "%.0f Steps", healthStore.stepCount)
                    )
                    ...
                    HealthDataCardView(
                        title: "Calories (Basal Energy)",
                        value: String(format: "%.0f kcal", healthStore.basalEnergy)
                    )
                    
                    HealthDataCardView(
                        title: "Respiratory Rate",
                        value: String(format: "%.1f breaths/min", healthStore.respiratoryRate)
                    )
